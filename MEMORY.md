...
- [Active plan](Harness/tasks/progress-restructure/PLAN.md)
...
- [Dispatch protocol](Harness/dispatch.md)
- [Subagent orchestration](Harness/subagents.md)
- [Extension contract](Harness/extension.md)
- [Architecture docs](Harness/architecture.md)
- [Agent workflow](Harness/agent-workflow.md)
- [Harness validator](Harness/scripts/validate-harness.mjs)

## Memory Folder

- [Tool usage/reflections](Harness/memory/tool-usage-reflections.md) - repeated tool failures, better command patterns, environment-specific fixes.
- [User corrections/preferences](Harness/memory/user-corrections-preferences.md) - repeated user corrections, durable preferences, common-sense course corrections.
- [Agent lessons/patterns](Harness/memory/agent-lessons-patterns.md) - reusable lessons from review, debugging, validation, and handoff loops.
