---
name: wf-auto
description: Perpetual auto-optimization mode. Never stops — continuously improves code until 8-angle exhaustion. Adaptive checkpoints, external spark search, evidence ledger. Use for /wf-auto, auto mode, or when the user wants unbounded self-directed optimization.
---
...
- **Trigger**: `/wf-auto`, `wf auto`, `auto mode`, or user wants continuous self-directed improvement
